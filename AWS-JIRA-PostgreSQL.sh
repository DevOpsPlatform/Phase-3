...
#Once the JIRA configuration is completed, then again connect back to your db "jiradb" and then verify the table by default created by the JIRA in prostgreSQL.
echo'
su - postgres 
...
#download jira
sudo wget  https://www.atlassian.com/software/jira/downloads/binary/atlassian-jira-software-8.18.1-x64.bin
...
chmod a+x atlassian-jira-software-8.18.1-x64.bin

sudo ./atlassian-jira-software-8.18.1-x64.bin
